...
export const siteData = {
  ...
  jobs: [
    {
      title: '【横浜エリア】定期便ドライバー / 神奈川県横浜市・川崎市',
      schedule: '8:00〜19:00（シフト制）',
      reward: '日額15,000円〜 / 月収33万円前後',
      body: '企業配送や固定ルート配送を中心に、毎月の見通しを持って働きやすい案件です。',
      examples: ['22日稼働の目安: 月33万円前後', '未経験からでも入りやすい固定案件あり'],
      isRecruiting: true,
      theme: 'regular',
    },
    {
      title: '【スポット配送】神奈川県内・東京都内',
      schedule: '早朝・午前中・午後など案件により変動',
      reward: '案件単価6,000円〜15,000円',
      body: '単発や短時間案件を組み合わせ、空き時間を活かしながら柔軟に収入を積み上げられます。',
      examples: ['月収40万円〜60万円を目指せる構成も相談可', '詳細はお問い合わせください'],
      isRecruiting: false,
      theme: 'spot',
    },
    {
      title: '【夜間仕分け】横浜・県央エリア',
      schedule: '20:00〜翌1:00 など案件により変動',
      reward: '5時間 7,000円〜 / 副業相談可',
      body: '本業後の時間帯を活かしやすく、短時間で収入をつくりたい方向けの働き方です。',
      examples: ['ダブルワーク希望の方とも相性の良い時間帯です', '開始前に業務の流れを共有します'],
      isRecruiting: false,
      theme: 'night',
    },
  ],
